...
SECRET_KEY = 'django-insecure-v1wcc-+_kzlfx)082ig_zm#_!i(kpzj-q(x3gn5gba7z35w$d_'
...
DATABASES = {
    'default': {
        'ENGINE': 'django_mongodb_backend',
        'NAME': get_env_value('DB_NAME', required=True),
        'HOST': get_env_value('DB_HOST', '127.0.0.1'),
        'USER': get_env_value('DB_USER'),
        'PASSWORD': get_env_value('DB_PASSWORD'),
        'OPTIONS': {
            'authSource': get_env_value('DB_AUTH_SOURCE', 'admin'),
        },
    }
}
